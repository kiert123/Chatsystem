...
// --- UPDATED: Class name renamed from ClientGUI to Client2 ---
public class Client2 {

    JFrame loginFrame = new JFrame("Portal Access");
    JFrame chatFrame = new JFrame("Terminal Stream (Client 1)");
    ...
    // --- Cool Cyberpunk Matrix Design System Applied ---
    final Color CANVAS_BG = new Color(14, 16, 18);     
    final Color CARD_BG = new Color(24, 28, 32);       
    final Color INPUT_BG = new Color(36, 42, 48);      
    final Color MATRIX_GREEN = new Color(0, 230, 118); 
    final Color TEXT_WHITE = new Color(240, 244, 248);  
    final Color TEXT_MUTED = new Color(110, 125, 140);  
    ...
    public void buildLoginUI() {
        ...
        card.setBorder(BorderFactory.createCompoundBorder(
            BorderFactory.createLineBorder(new Color(40, 48, 56), 1),
            BorderFactory.createEmptyBorder(10, 10, 10, 10)
        ));

        JLabel title = new JLabel("SECURE PORTAL", SwingConstants.CENTER);
        title.setFont(new Font("Segoe UI", Font.BOLD, 22));
        title.setForeground(MATRIX_GREEN);
        ...
        userField.setBackground(INPUT_BG); userField.setForeground(TEXT_WHITE); userField.setCaretColor(MATRIX_GREEN);
        ...
        passField.setBackground(INPUT_BG); passField.setForeground(TEXT_WHITE); passField.setCaretColor(MATRIX_GREEN);
        ...
        loginBtn.setBackground(MATRIX_GREEN); loginBtn.setForeground(CANVAS_BG);
    ...
    public void buildChatUI() {
        ...
        JLabel status = new JLabel("Connected session: " + username + " (Client 1)");
        status.setFont(new Font("Segoe UI", Font.BOLD, 15)); status.setForeground(MATRIX_GREEN);
        ...
        messageInput.setBackground(CARD_BG); messageInput.setForeground(TEXT_WHITE); messageInput.setCaretColor(MATRIX_GREEN);
        ...
        sendBtn.setBackground(MATRIX_GREEN); sendBtn.setForeground(CANVAS_BG);
    ...
    public static void main(String[] args) {
        // --- UPDATED: Initializer calls Client1 constructor ---
